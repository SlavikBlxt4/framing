...
public class UserController {
    ...
    @GetMapping("/services")
    public List<ServiceResponseDTO> findByPhotographerId(Authentication authentication) {
        CustomAuthenticationToken authToken = (CustomAuthenticationToken) authentication;
        Integer clientId = authToken.getUserId();
        List<ServiceClass> services = serviceRepository.findByPhotographerId(clientId);
